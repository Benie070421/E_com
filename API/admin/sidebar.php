        ...
        <div class="col-xl-2 col-md-3 col-sm-12" id="side-bar">
            <ul class="list-group list-group-flush fixed shadow-sm bg-indigo" >
                <li class="list-group-item bg-indigo "><a href="#" class="nav-link  text-center">
                    <img src="assets/images/img5.jpeg" class="shadow" style="height: 100px; width: 100px;">
                    <h5>AXOU</h5>
                ...
                <li class="nav-item-produit">
                    ...
                    <div class="collapse" id="ui-basic">
                      <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link text-white" href="assets/pages/pageproduits.php">Produits en stock </a></li>
                        <li class="nav-item"> <a class="nav-link text-white" href="assets/pages/pagecommandes.php">Commandes</a></li>
                      </ul>
                    </div>
                </li>
                <!-- <li class="list-group-item bg-indigo "><a href="#" class="nav-link"><span class="fa fa-home"></span> </a></li> -->
                <li class="list-group-item bg-indigo "><a href="assets/pages/pageadmin.php" class="nav-link"><span class="fa fa-table"></span> Gestion des Administrateurs</a></li>
                <li class="list-group-item bg-indigo "><a href="assets/pages/pageparametre.php" class="nav-link"><span class="fa fa-cogs"></span> Paramètre du compte</a></li>
