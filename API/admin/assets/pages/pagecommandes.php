...
<body>
    <div class="row no-getters">
        ...
        <div class="col-xl-10 col-md-9 col-sm-12" id="content">
            ...
            <!--table-->
                        <?php
            $prod = "SELECT* FROM commande LEFT JOIN user ON commande.client = user.id LEFT JOIN produit ON commande.produit = produit.id ";
      ...
      ?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <center><h4 class="card-title1 text-black">COMMANDES</h4></center>
